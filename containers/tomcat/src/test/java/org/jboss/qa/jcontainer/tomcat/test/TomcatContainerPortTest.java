...
public class TomcatContainerPortTest extends ContainerTest {
	...
	public static void beforeClass() throws Exception {
		final TomcatConfiguration conf = TomcatConfiguration.builder().directory(TOMCAT_HOME).xmx("512m")
				.httpPort(HTTP_PORT).build();
	...
	public void httpPortTest() {
		Assert.assertTrue(container.checkSocket());
	}
}
