...
public class WildflyConfigurationTest {
	...
	public void javaOptsDefaultTest() {
		...
		final List<String> options = Arrays.asList(conf.getEnvProps().get(WildflyConfiguration.JAVA_OPTS_ENV_NAME).split(" "));
	...
	public void java17Test() {
		...
		final WildflyConfiguration config = WildflyConfiguration.builder().build();
